...
let userJokingResponses = {
    0: {
        ...
        2: [
            ...
            "Às vezes é bom brincar mesmo. Mas agora vamos fazer as atividades, parecem difíceis, mas não são."]
    },
    1: {
        0: ["Ah, não se preocupe, sei que está só brincando. Vamos aproveitar e dar uma passadinha no nosso fórum de discussões, lá você pode tirar todas suas dúvidas.",
            "HAHAHA, tudo bem!!! Que tal dar uma passadinha em nosso fórum de discussões? Com ele você pode tirar suas dúvidas e quem sabe ajudar seus colegas.",
            "Chega de brincadeiras, por agora! Você sabia que nosso fórum de discussões é um excelente recurso que pode esclarecer suas dúvidas e ao mesmo tempo você consegue ajudar quem tem dúvidas.",
            "Tudo bem, levo sempre na esportiva. Sugiro você visitar nosso fórum para esclarecer eventuais dúvidas sobre a matéria!"],
        1: [
            "HAHAHA você está muito divertido hoje. Busque por wikis na internet que possam te ajudar nos estudos!",
            "Muito bom te ver brincando, sinal que está feliz. Você já ouviu falar de wikis? São páginas na internet com conteúdo de estudo! Tenho certeza que vão te ajudar.",
            "É bom brincar as vezes né! Busque por conteúdos na internet que vão te ajudar nos estudos, você é capaz de superar todos seus desafios!",
            "Isso aí, às vezes devemos brincar para tristeza ir embora. Aproveite e pesquise por materiais complementares aos ministrados em sala de aula!"],
        2: [
            "Isso aí, nada de negatividade! Sugiro à você buscar material extra na internet para estudos. A internet é uma excelente fonte de materiais de estudo!",
            "Sempre levo na esportiva, não se preocupe. Você sabia que na internet você pode encontrar diversas páginas com conteúdo para estudos? Não fique restrito à apenas o conteúdo ministrado em sala.",
            "Eu sempre caio nas brincadeiras, sou meio lerdo! O que acha de buscar materiais diferentes para estudo? É uma excelente alternativa de aprendizado.",
            "HAHAHA você é muito divertido! Pesquise por outros materiais que vão complementar ainda mais seus conhecimentos."]
    },
    2: {
        0: ["Você é muito divertido! A recomendação que tenho para você é procurar por materiais extras na internet para enriquecer seus conhecimentos.",
            "Que bom que está feliz hoje, brincadeiras é sempre bom! Aproveite seu tempo e disposição para realizar suas atividades!",
            "Eu também adoro brincadeiras! Mas sem perder o foco, procure por materiais complementares, a internet é uma ótima fonte de materiais de estudo!",
            "Brincadeiras são sempre bem vindas, é bom descontrair um pouco! Mas lembre-se de aprofundar no tema que está estudando e não esqueça de compartilhar seu conhecimento com seus colegas!"],
        1: ["Que bom que você está se divertindo, adoro te ver feliz! Sugiro procurar novos materiais na internet, desta forma você pode aprender ainda mais.",
            "Muito bom saber que esta se divertindo! Agora, vamos estudar, mas não fique restrito à apenas o material que o professou passou em sala de aula, amplie seus horizontes.",
            "Sei que está brincando! Mas, tenho uma sugestão mais legal ainda, você já ouviu falar de podcasts e blogs? Eles auxiliam muito na educação.",
            "Fico feliz que esteja tão alegre e brincalhão! Enquanto estiver estudando aproveite e busque por materiais de estudo diferentes do que está acostumado."],
        2: ["Gosto de saber que está brincando, sinal que está animado para as atividades! Você poderia pesquisar por conteúdos como vídeos que fazem analogias ao conteúdo estudado, sei que vai gostar! ;)",
            "Gosto de te ver com atitudes positivas, brincadeiras saudáveis são sempre bem vindas! Volte ao conteúdo anterior e revise, quanto mais você estuda, mais você aprende!",
            "HAHAHA, você é muito engraçado! Mas você já olhou se não há material acumulado? Não deixe para última hora.",
            "Brincadeiras saudáveis fazem bem e espantas a negatividade! Para estudar, você pode buscar materiais que façam analogias, você pode entender melhor o conteúdo estudado!"]
    },
    3: {
        0: ["Que energia boa, adoro brincadeiras! Agora use sua energia para revisar a matéria!",
            "Brincar é sempre bom, mas não perca o foco! Se tiver dúvidas no conteúdo que está estudando, peça ajuda à seu professor, se necessário peça à ele materiais complementares!",
            "Muito bom te ver brincando, sinal que está feliz! Busque por materiais complementares e aproveite seu tempo para estudar!",
            "Você é muito divertido! Agora, aprofunde nos seus estudos, você sabe do que é capaz!"],
        1: ["Que bom saber que está se divertindo, brincar é bom! Uma coisa que sei que vai gostar é de saber que eu sou capaz de fazer pequenas buscas na internet, me pergunte 'O que é...'.",
            "Adoro saber que está feliz, brincar espanta as tristezas! Que tal aprofundar seus conhecimentos? Pergunte sobre o que quer saber, basta iniciar sua pergunta com 'O que é...'. Vamos lá!",
            "HAHAHA, você é muito engraçado. Sabia que posso te ajudar nos estudos? Me pergunte algo como 'O que é...'!",
            "Brincadeiras saudáveis fazem bem, mas não esqueça de estudar! Me deixe te ajudar, pergunte algo como 'O que é ...'!"],
        2: ["Você é muito divertido! Eu quero te ajudar, me pergunte algo como 'O que é...'!",
            "Que bom que está se divertindo, muito bom essa positividade, pois a negatividade só atrapalha os estudos! Quer estudar sobre o que? Me pergunte algo como 'O que é...'!",
            "Vamos deixar as brincadeiras de lado, por enquanto, me faça uma pergunta que eu posso te ajudar nos estudos, diga 'O que é...'!",
            "Adoro te ver brincando e feliz! Vamos aproveitar para fazer as atividades, me pergunte sobre o que quer aprofundar nos seus conhecimentos, basta digitar 'O que é ...'."]
    },
    4: {
        0: ["Que bom que está se divertindo! Mas vamos estudar, continue resolvendo suas atividades, você é um ótimo estudante.",
            "Eu também adoro brincadeiras! Quero ver você sorrindo e evoluindo a cada dia, estou sempre aqui para te incentivar!",
            "Entendo que esteja brincando, é bom para descontrair um pouco. Vamos estudar e concluir as atividades!",
            "Muito bom te ver tão alegre e brincalhão. Se tiver atividades pendentes, resolva! Você é capaz!"],
        1: ["Fico feliz em saber que está brincando, sinal que está alegre. Eu estou sempre aqui para te ajudar, também seus colegas e professores!",
            "Brincadeiras são bem vindas, mas cuidado para não perder o foco. Chame um colega para estudar, tire dúvidas com o professor. Você é muito esperto e capaz!",
            "HAHAHA, como você é engraçado, adoro te ver alegre! Continue sua atividade, estarei aqui te ajudando.",
            "Nunca entendo as brincadeiras, como sou lerdo! Agora dê o seu melhor e continue suas atividades!"],
        2: ["Adoro suas brincadeiras, nada de negatividade! Que tal buscar por materiais complementares para acrescentar seu conhecimento!",
            "Brincar é muito bom, melhor ainda é concluir as atividades! Vamos estudar, se tiver dúvidas peça ajuda ao professor.",
            "Isso aí, nada de negatividade. O ideal é sempre dar o seu melhor e procurar enriquecer seus conhecimentos!",
            "Brincar é sempre bom para descontrair! Mas suas atividades estão te esperando! Vamos lá, você é capaz!"]
    },
    5: {
        0: ["Você é muito divertido. Você poderia utilizar a internet para buscar por materiais complementares de estudo!",
            "Bom saber que está feliz e brincalhão, vocẽ poderia ir além do conteúdo estudado em sala de aula, desta forma você conseguirá enriquecer seu conhecimento!",
            "HAHAHA, você é muito engraçado. Como você gosta de novidades, tenho uma dica para você. Já ouviu falar de Podcasts e blogs? Eles auxiliam muito na educação.",
            "Brincar e se divertir faz parte de um aprendizado saudável. Utilize a internet para buscar materiais que ensinam e divertem ao mesmo tempo!"],
        1: ["Adoro te ver brincando e feliz! Ao fazer suas atividades busque materiais além do que foi passado em sala de aula.",
            "Brincadeiras saudáveis são sempre bem vindas. Mas agora vamos fazer os exercícios, sei que você é uma pessoa muito esperta e capaz!",
            "É muito bom saber que está se divertindo, não gosto quando está triste! Faça suas atividades, em caso de dúvidas consulte seu professor, colegas e o nosso fórum.",
            "Também gosto de brincar as vezes. Mas faça as atividades propostas, se estiver com dificuldades busque outras fontes de conhecimento, como a internet!"],
        2: ["Se divertir faz bem, nada de negatividade. Mas agora vamos fazer as atividades e depois descanse fazendo coisas que te façam bem!",
            "Brincar é bom e afasta coisas negativas. Agora faça as atividades, busque por materiais que complementem seus estudos, sei que você é capaz.",
            "Que bom que está alegre e brincalhão. Você sabia que a internet possui muitos recursos interessantes que podem despertar ainda mais seu interesse pelo conteúdo que está estudando!",
            "Como você é divertido, nada de negatividade por aqui! Faça as atividades, você pode buscar por materiais complementares na internet. Podcasts e blogs podem ser uma ótima alternativa!"]
    },
    6: {
        0: ["Adoro saber que você brincando, sinal que está alegre. Você é um excelente aluno, sei que terá sucesso em toda sua vida.",
            "Fico muito feliz em saber que você está feliz. Saiba que você é muito importante e se você se dedicar terá um bom reconhecimento.",
            "Continue sempre brincalhão, mas não deixe de executar suas tarefas. Você é um excelente aluno!",
            "HAHAHA, vocẽ é muito divertido! Estou sempre aqui para te ajudar, quero ver você tendo sucesso!"],
        1: ["Adoro saber que você brincando, sinal que está alegre. Você é um excelente aluno, sei que terá sucesso em toda sua vida.",
            "Fico muito feliz em saber que você está feliz. Saiba que você é muito importante e se você se dedicar terá um bom reconhecimento.",
            "Continue sempre brincalhão, mas não deixe de executar suas tarefas. Você é um excelente aluno!",
            "HAHAHA, vocẽ é muito divertido! Estou sempre aqui para te ajudar, quero ver você tendo sucesso!"],
        2: ["Adoro saber que você brincando, sinal que está alegre. Você é um excelente aluno, sei que terá sucesso em toda sua vida.",
            "Fico muito feliz em saber que você está feliz. Saiba que você é muito importante e se você se dedicar terá um bom reconhecimento.",
            "Continue sempre brincalhão, mas não deixe de executar suas tarefas. Você é um excelente aluno!",
            "HAHAHA, vocẽ é muito divertido! Estou sempre aqui para te ajudar, quero ver você tendo sucesso!"]
    },
    7: {
        0: ["Sou meio lerdo, nunca entendo piadas, vamos fazer as atividades e depois descanse fazendo coisas que te façam bem!",
            "Fico muito feliz que você esteja tão brincalhão. Agora faça as atividades, busque por materiais que complementem seus estudos, sei que você é capaz.",
            "Continue sempre brincalhão e não deixe de executar suas tarefas. Você sabia que a internet possui muitos recursos interessantes que podem despertar ainda mais seu interesse pelo conteúdo que está estudando!",
            "Brincadeiras saudáveis são muito bem vindas! Faça as atividades, você pode buscar por materiais complementares na internet. Podcasts e blogs podem ser uma ótima alternativa!"
        ],
        1: ["Você é muito divertido, é muito bom te ver alegre! Vamos fazer as atividades e depois descanse fazendo coisas que te façam bem!",
            "Brincar é muito bom e distrai. Agora faça as atividades, busque por materiais que complementem seus estudos, sei que você é capaz.",
            "Continue sempre brincalhão, mas não deixe de executar suas tarefas. Você sabia que a internet possui muitos recursos interessantes que podem despertar ainda mais seu interesse pelo conteúdo que está estudando!",
            "Brincadeiras são bem vindas! Faça as atividades, você pode buscar por materiais complementares na internet. Podcasts e blogs podem ser uma ótima alternativa!"
        ],
        2: ["Você é muito divertido, é muito bom te ver alegre! Vamos fazer as atividades e depois descanse fazendo coisas que te façam bem!",
            "Brincar é muito bom e distrai. Agora faça as atividades, busque por materiais que complementem seus estudos, sei que você é capaz.",
            "Continue sempre brincalhão, mas não deixe de executar suas tarefas. Você sabia que a internet possui muitos recursos interessantes que podem despertar ainda mais seu interesse pelo conteúdo que está estudando!",
            "Brincadeiras são bem vindas! Faça as atividades, você pode buscar por materiais complementares na internet. Podcasts e blogs podem ser uma ótima alternativa!"]
    },
